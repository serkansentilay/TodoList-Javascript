// SELECTORS
let taskInput = document.querySelector("#task") //input id value
let liveToastBtn = document.querySelector("#liveToastBtn") //button id value
let list = document.querySelector("#list") // ul id value
let addAlert = document.querySelector("#liveToast") // div toast id value
